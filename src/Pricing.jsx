...
const GetStarted = () => {
  return (
    <a href="https://app.visivo.io/register" className="my-8 rounded-lg bg-gray-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:ring-4 focus:ring-gray-200 dark:bg-gray-600 dark:text-white  dark:hover:bg-gray-500 dark:focus:ring-gray-600">Get started</a>
  )
}
        ...
        <div className="mx-auto max-w-screen-xl px-4 pt-20 sm:pt-24 lg:pt-32">
          ...
          <div className="mt-8 grid gap-8 sm:mt-12 xl:grid-cols-4 xl:gap-3">
            <Card>
              ...
              <p className="mb-1 mt-4 text-gray-500 dark:text-gray-400">$19 USD per month, paid annually</p>
              <GetStarted />
            ...
            <Card>
              <div className="mb-2">
                <span
                  className="rounded bg-primary-100 px-3 py-1 text-sm text-primary-800 dark:bg-primary-900 dark:text-primary-300">Most popular</span>
              </div>
              <h3 className="mb-4 text-2xl font-medium text-gray-900 dark:text-white">
                Pro
              </h3>
              <span className="text-5xl font-extrabold text-gray-900 dark:text-white">$199</span>
              <p className="mb-1 mt-4 text-gray-500 dark:text-gray-400">$159 USD per month, paid annually</p>
              <GetStarted />
              <ul role="list" className="space-y-4 text-left text-gray-900 dark:text-gray-400">
                <li className="flex items-center space-x-3">
                  <svg className="size-5 shrink-0" fill="currentColor" viewBox="0 0 20 20"
            ...
            <Card>
              ...
              <p className="mb-1 mt-4 text-gray-500 dark:text-gray-400">$499 USD per month, paid annually</p>
              <GetStarted />
              <ul role="list" className="space-y-4 text-left text-gray-900 dark:text-gray-400">
                <li className="flex items-center space-x-3">
                  <svg className="size-5 shrink-0" fill="currentColor" viewBox="0 0 20 20"
