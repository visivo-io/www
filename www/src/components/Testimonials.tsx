      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:py-24">
        <div id="testimonial-carousel" className="relative text-center" data-carousel="slide">
          <div className="relative mx-auto h-52 max-w-screen-md overflow-x-hidden overflow-y-visible rounded-lg sm:h-48">
            ...
            <figure className="mx-auto hidden w-full max-w-screen-md" data-carousel-item>
              <blockquote>
                <p className="text-lg font-medium text-gray-900 sm:text-2xl dark:text-white">"Flowbite is just awesome. It
                  contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect
              ...
              <figcaption className="mt-6 flex items-center justify-center space-x-3">
                ...
                <div className="flex items-center divide-x-2 divide-gray-200 dark:divide-gray-700">
                  ...
                  <div className="pl-3 text-sm text-gray-500 dark:text-gray-400">Web developer at Google</div>
                </div>
              </figcaption>
            </figure>
