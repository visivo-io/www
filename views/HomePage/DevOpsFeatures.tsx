...
export default function DevOpsFeatures() {
  return (
    <FeaturesWrapper>
        ...
        <BasicSection imageUrl="/images/pull-request.webp" title="Keep your HEAD clear & commit to git" overTitle="Version Control">
        <p>
        ...
        <BasicSection imageUrl="/images/git-workflow.webp" title="Deployments that mirror your workflow" overTitle="CI/CD" reversed>
        <p>
        ...
        <BasicSection imageUrl="/images/continuous-testing.webp" title="Goodbye broken dashboards" overTitle="Testable">
        <p>
